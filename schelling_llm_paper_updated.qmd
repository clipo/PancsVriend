...
The dynamics varied significantly across contexts. Political scenarios showed low mobility once initial patterns formed (switch rate 0.076), while economic scenarios maintained high mobility throughout (switch rate 0.471), suggesting ongoing residential churn rather than stable integration. Racial and ethnic scenarios showed intermediate patterns with eventual stabilization.
