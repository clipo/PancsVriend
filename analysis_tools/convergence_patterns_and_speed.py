...
# The two 90%-convergence progress figures (convergence_progress_90pct.png and
# convergence_progress_90pct_dissimilarity_index.png) were removed from the pipeline
# on 2026-09-15 (user decision). The code is kept below, commented out, for ad-hoc use;
# the flags stay defined for anything downstream that reads them.
