...
``analysis/run_summary_by_run_all_scenarios.csv`` (one row per simulation run, final-step
...
def collect(runs_root, include_legacy=False):
    ...
    pattern = os.path.join(runs_root, "run_*", "analysis", "run_summary_by_run_all_scenarios.csv")
