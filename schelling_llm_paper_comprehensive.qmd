...
- Mixed-income housing developments may face less resistance than anticipated
...
Our policy analysis reveals actionable insights: economic integration appears most achievable and could serve as an entry point for broader efforts, while political segregation requires entirely different interventions focused on shared local interests rather than ideological identity. The finding that memory reduces extreme segregation by 53.8% points to the importance of policies that promote residential stability and positive intergroup experiences.

As LLMs continue to improve, they offer unprecedented opportunities to model complex social phenomena with greater realism. Importantly, our framework enables policymakers to test interventions virtually before implementation, potentially saving resources and avoiding unintended consequences. However, researchers must carefully consider what biases these models may perpetuate and how to validate their outputs against empirical data.

The integration of LLMs into classic models like Schelling's opens new frontiers in computational social science, enabling us to ask not just "what if agents prefer similar neighbors?" but "what if agents think and decide like humans?"—and crucially, "what policies might actually work in a world where identity and context matter as much as proximity?"
